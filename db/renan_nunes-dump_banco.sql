...
CREATE TABLE `tarefa` (
  ...
  `TAREFAcol` enum('baixa','média','alta') DEFAULT NULL,
  `data_cadastro_tarefa` datetime DEFAULT current_timestamp(),
  `status_tarefa` enum('a fazer','fazendo','pronto') DEFAULT 'a fazer',
  PRIMARY KEY (`id_tarefa`),
  KEY `fk_TAREFA_USUARIO` (`USUARIO_id_usuario`),
...
-- Dump completed on 2025-06-11 19:22:08
